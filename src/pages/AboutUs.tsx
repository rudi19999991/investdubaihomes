  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow pt-20">
        <HeroSection
          title={translate("About Invest Dubai")}
          subtitle={translate("Your trusted partner in Dubai and Ras Al Khaimah real estate since 2005")}
          backgroundImage="https://images.unsplash.com/photo-1546412414-e1885e51cfa5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2340&q=80"
          showCta={false}
        />
            ...
            <div className="flex flex-col md:flex-row gap-12">
              ...
              <div className="md:w-1/2">
                <div className="rounded-lg overflow-hidden h-full">
                  <img 
                    src="https://images.unsplash.com/photo-1582650625119-3a31f8fa2699?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2340&q=80" 
                    alt="Dubai Skyline" 
